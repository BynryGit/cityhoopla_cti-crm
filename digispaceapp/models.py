...
#
# class EnquiryResults(models.Model):
#     ResultID                        =       models.AutoField(primary_key=True, editable=False)
#     EnquiryID                =       models.ForeignKey(EnquiryDetails,blank=True,null=True)
#     CallerID                =       models.ForeignKey(CallerDetails,blank=True,null=True)
#     Advert_list                  =       models.CharField(blank=True,null=True,max_length=200,default=None)
#     RespondedToCaller              = models.CharField(default="1",null=True,max_length=100, choices=response)
#     SMS_Response              = models.CharField(default="1",null=True,max_length=100, choices=response)
#     Email_Response              = models.CharField(default="1",null=True,max_length=100, choices=response)
#     Callback_Response              = models.CharField(default="1",null=True,max_length=100, choices=response)
#     created_date              =       models.DateTimeField(null=True,blank=True)
#     created_by                =       models.CharField(max_length=100,null=True,blank=True)
#     updated_by                =       models.CharField(max_length=100,null=True,blank= True)
#     updated_date              =       models.DateTimeField(null=True,blank=True)
#
#     def __unicode__(self):
#         return unicode(self.ResultID)
#
# class ResponseDetails(models.Model):
#     ResponseID                        =       models.AutoField(primary_key=True, editable=False)
#     ResultID                =       models.ForeignKey(EnquiryResults,blank=True,null=True)
#     EnquiryID                =       models.ForeignKey(EnquiryDetails,blank=True,null=True)
#     CallerID                =       models.ForeignKey(CallerDetails,blank=True,null=True)
#     Advert_id                  =       models.CharField(blank=True,null=True,max_length=100,default=None)
#     ResponseTimeDate              =       models.DateTimeField(null=True,blank=True)
#     created_date              =       models.DateTimeField(null=True,blank=True)
#     created_by                =       models.CharField(max_length=100,null=True,blank=True)
#
#     def __unicode__(self):
#         return unicode(self.ResponseID)
...
class ConsumerProfile(User):
    ...
    no_of_login                      =       models.CharField(max_length=100, default="0", blank=True, null=True)
...
class Advert(models.Model):
    ...
    updated_by = models.CharField(max_length=500, null=True, blank=True)
    updation_date = models.DateTimeField(null=True, blank=True)
    advert_views = models.CharField(max_length=10, default="0", null=True, blank=True)
