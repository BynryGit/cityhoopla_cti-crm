...
urlpatterns = patterns('',
    ...
    # url(r'^crm_login_form/', 'Admin.views.crm_login_form',name='crm_login_form'),
    # url(r'^crm_login/', 'Admin.views.crm_login',name='crm_login'),
    # url(r'^crm_home/', 'Admin.views.crm_home',name='crm_home'),
    # url(r'^crm_details/', 'Admin.views.crm_details',name='crm_details'),
    # url(r'^get-enquiry-details/', 'Admin.views.get_enquiry_details',name='get_enquiry_details'),
    # url(r'^get-consumer-detail/', 'Admin.views.get_consumer_detail',name='get_consumer_detail'),
    # url(r'^new_consumer/', 'Admin.views.new_consumer',name='new_consumer'),
    # url(r'^save_consumer_details/', 'Admin.views.save_consumer_details',name='save_consumer_details'),
    # url(r'^enquiry_form/', 'Admin.views.enquiry_form',name='enquiry_form'),
    # url(r'^enquiry_search_results/', 'Admin.views.enquiry_search_results',name='enquiry_search_results'),
    # url(r'^get-pincode-list/', 'Admin.views.get_pincode_list',name='get_pincode_list'),
    # url(r'^enquiry-search-details/', 'Admin.views.enquiry_search_details',name='enquiry_search_details'),
    # url(r'^demo_function/', 'Admin.views.demo_function',name='demo_function'),
    # url(r'^save-enquiry-details/', 'Admin.views.save_enquiry_details',name='save_enquiry_details'),
    #
    # url(r'^callinfo/', 'Admin.views.caller_details_api',name='caller_details_api'),
    ...
    url(r'^text-search/', 'Admin.advert.text_search',name='text_search'),
    url(r'^advert-search/', 'Admin.advert.advert_search',name='advert_search'),
    url(r'^all-search/', 'Admin.advert.all_search',name='all_search'),
    url(r'^search-details/', 'Admin.advert.search_details',name='search_details'),
